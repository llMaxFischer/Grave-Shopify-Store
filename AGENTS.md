...
- **CSS**: `assets/grave-v46.css` (latest version)
- **About page CSS**: `assets/about-page-v2.css`
- **theme.liquid**: references `grave-v46.css` on line 341 and `about-page-v2.css` on line 342
- Next version when making changes: `grave-v47.css`

### Deploy Process (follow EVERY time)
1. **Create a NEW CSS file** with the next version number (e.g., `grave-v47.css`)
...
### ⚠️ NEVER DO THIS
- Editing `grave-v46.css` and re-uploading (CDN serves old version)
...
## Key Files
- `assets/grave-v46.css` — current active custom CSS file
- `layout/theme.liquid` — references `grave-v46.css`
